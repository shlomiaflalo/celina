  ...
  return (
    <div>
      <Seo
        ...
        description="Все города Селины на одной странице: Россия — от Москвы до Владивостока, плюс страницы Беларуси, Казахстана, Узбекистана, Армении, Украины, Кыргызстана, Молдовы, Грузии, Азербайджана и Таджикистана. Выберите свой город и посмотрите, кто готовит рядом."
        path="/eda"
        jsonLd={jsonLd}
      />
      <h1 className="t-h1 mb-3">Домашняя еда по городам</h1>
      <p className="t-lead mb-8 max-w-3xl">
        Селина работает в России с июля 2026 года; в соседних странах мы пока собираем список
      ...
      <div className="space-y-8">
        {groups.map(({ co, cities }) => (
          <section key={co.code}>
            ...
            {/* белый, не оранжевый: страница живёт на оранжевом .band-brand,
                оранжевый текст здесь невидим (замечание основателя 22.08) */}
            {!co.operates && (
