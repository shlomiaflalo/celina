...
export function LandingSections() {
  ...
  const stat = (n: number | undefined, label: string) => (
    <div className="text-center text-white">
      <div className="text-4xl font-extrabold drop-shadow sm:text-5xl">
        <CountUp value={n} />+
      </div>
  ...
  return (
    <div className="border-t border-white/50">
      ...
      <section className="mx-auto max-w-5xl px-6 py-16">
        <Reveal>
          {s && s.cooks >= 10 && s.buyers >= 10 && s.dishes >= 10 ? (
            <>
              <h2 className="text-center text-2xl font-bold text-white drop-shadow sm:text-3xl">{t.landing.statsTitle}</h2>
              <p className="mb-10 mt-1 text-center text-sm text-white/75">{t.landing.growth}</p>
            ...
            <>
              <h2 className="text-center text-2xl font-bold text-white drop-shadow sm:text-3xl">{t.landing.valueTitle}</h2>
              <p className="mb-10 mt-1 text-center text-sm text-white/75">{t.landing.valuePilotNote}</p>
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-6">
                <div className="min-w-0 text-center text-white">
                  <div className="break-words text-[clamp(1.25rem,7vw,1.875rem)] font-extrabold drop-shadow sm:text-5xl">{t.landing.value1}</div>
                  <div className="mt-1 break-words text-xs font-medium text-white/85 sm:text-sm">{t.landing.value1Label}</div>
                </div>
                <div className="min-w-0 text-center text-white">
                  <div className="break-words text-[clamp(1.25rem,7vw,1.875rem)] font-extrabold drop-shadow sm:text-5xl">{t.landing.value2}</div>
                  <div className="mt-1 break-words text-xs font-medium text-white/85 sm:text-sm">{t.landing.value2Label}</div>
                </div>
                <div className="min-w-0 text-center text-white">
                  <div className="break-words text-[clamp(1.25rem,7vw,1.875rem)] font-extrabold drop-shadow sm:text-5xl">{t.landing.value3}</div>
                  <div className="mt-1 break-words text-xs font-medium text-white/85 sm:text-sm">{t.landing.value3Label}</div>
                </div>
              </div>
            </>
          )}
      ...
      <section className="border-t border-white/50 py-12">
        <h2 className="mb-10 text-center text-2xl font-bold text-white drop-shadow sm:text-3xl">{t.landing.tasteTitle}</h2>
        <MatryoshkaGallery />
      </section>

      {/* размер рынка / видение */}
      <section className="border-t border-white/50 px-6 py-16">
        <Reveal className="mx-auto max-w-5xl">
          <h2 className="text-center text-2xl font-bold text-white drop-shadow sm:text-3xl">{t.landing.visionTitle}</h2>
          <p className="mx-auto mb-10 mt-2 max-w-2xl text-center text-white/85">{t.landing.visionText}</p>
          <div className="grid gap-6 sm:grid-cols-3">
            {vision.map((v) => (
              <div key={v.label} className="text-center text-white">
                <div className="text-4xl font-extrabold drop-shadow sm:text-5xl">{v.stat}</div>
                <div className="mx-auto mt-1 max-w-[14rem] text-sm font-medium text-white/85">{v.label}</div>
              </div>
            ))}
          </div>
        </Reveal>
      ...
      <section className="border-t border-white/50 px-6 py-14">
        <div className="mx-auto max-w-5xl">
          <h2 className="text-center text-2xl font-bold text-white drop-shadow sm:text-3xl">{t.landing.trustTitle}</h2>
          <p className="mx-auto mb-9 mt-2 max-w-xl text-center text-white/85">{t.landing.trustSubtitle}</p>
      ...
      <section className="border-t border-white/50 px-6 py-14">
        <div className="mx-auto max-w-4xl">
          <h2 className="mb-9 text-center text-2xl font-bold text-white drop-shadow sm:text-3xl">{t.landing.howTitle}</h2>
          <div className="grid gap-4 sm:grid-cols-3">
            {steps.map((st, i) => (
      ...
      {/* факты о России */}
      <section className="border-t border-white/50 px-6 py-12">
        <div className="mx-auto max-w-4xl">
          <h2 className="mb-8 text-center text-2xl font-bold text-white drop-shadow sm:text-3xl">{t.landing.factsTitle}</h2>
          <div className="grid gap-4 sm:grid-cols-3">
      ...
      {/* CTA */}
      <section className="border-t border-white/50 px-6 py-16 text-center text-white">
        {/* «Присоединяйтесь» — длинное слово: на 320px оно на 3px шире колонки
            и обрезалось по краю. Плавный размер + перенос по слогам. */}
        <h2 className="break-words text-[clamp(1.5rem,7.5vw,1.875rem)] font-extrabold drop-shadow sm:text-4xl">{t.landing.ctaTitle}</h2>
        <p className="mx-auto mt-3 max-w-lg text-white/90">{t.landing.ctaText}</p>
        <button
      ...
      {/* о нас + контакты */}
      <div className="border-t border-white/50">
      <section className="mx-auto max-w-3xl px-6 py-12 text-center text-white">
        <h2 className="mb-3 text-2xl font-bold drop-shadow">{t.landing.aboutTitle}</h2>
        <p className="mx-auto max-w-xl text-white/90">{t.landing.about}</p>

        <div className="mt-8 text-sm text-white/70">{t.landing.contact}</div>
        <div className="mt-3 flex justify-center gap-3">
          {[
            ...
            <a
              ...
              rel="noreferrer"
              style={{ color: "#fff" }}
              className="flex h-11 w-11 items-center justify-center rounded-full border border-white/70 text-sm font-bold transition hover:bg-[rgba(255,255,255,0.18)]"
            >
              {soc.label}
            </a>
          ))}
          ...
          <button
            ...
            style={{ color: "#fff" }}
            className="flex h-11 w-11 items-center justify-center rounded-full border border-white/70 transition hover:bg-[rgba(255,255,255,0.18)]"
          >
      ...
      <footer className="border-t border-white/50 py-6 text-center text-xs text-white/80">
        ...
        <div className="mb-2 flex flex-wrap justify-center gap-x-4 gap-y-1 text-sm font-medium text-white">
          ...
          <PrivacyLink className="text-white" />
        </div>
        {t.landing.rights}
      </footer>
    </div>
