...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    en: {
      ...
      body: [
        ...
        { h: "Step 3. Delivery or pickup", p: ["Choose what suits you: delivery by the cook or pickup. During the free launch, payment is cash on delivery — directly to the cook, no fees or cards."] },
  ...
  },
  {
    ...
    en: {
      ...
      body: [
        ...
        { h: "Delivery or pickup — whatever suits you", p: ["Moscow is a city of distances, so you get a choice. The cook brings the order to your door, while pickup is handy when a cook works literally in the next building and you'd enjoy stopping by in person.", "During the free launch, payment is cash on delivery, directly to the cook. No cards, no prepayment: you pay when the order is already in your hands. That removes the main worry of a first order from someone new."] },
  ...
  },
  {
    ...
    links: [
      { to: "/login", label: "Стать поваром на Celina" },
  ...
  },
  {
    ...
    en: {
      ...
      body: [
        ...
        { h: "No time to bake? Order from a neighbor", p: ["Honestly: yeasted dough, the right cheese, and precise oven work take time and practice. If you want real khachapuri here and now, see who's cooking Georgian food near you. On Celina, home cooks sell their baking directly to neighbors — with delivery or pickup. During the free launch, payment is cash on delivery, straight to the cook, no cards or fees.", "Every cook passes identity verification and confirms they follow sanitary rules, and honest neighbor reviews help you choose. Check the baking section in your city — the best khachapuri might already be baking a couple of blocks away."] },
      ],
    },
  },
  {
    ...
    en: {
      ...
      body: [
        ...
        { h: "When it's easier to order homemade", p: ["Making good pelmeni is an hour or two of work and a mountain of dishes. If you want the real homemade thing without the kitchen marathon, see who's cooking near you. On Celina, home cooks shape pelmeni by hand from family recipes and sell them directly to neighbors — with delivery or pickup. During the free launch, payment is cash on delivery, straight to the cook, no cards or fees.", "Every cook passes identity verification and confirms they follow sanitary rules, and the ingredients and neighbor reviews are visible in advance. Check the hot dishes section in your city — someone might already be making the ones that taste \"just like grandma's.\""] },
  ...
  },
  {
    ...
    links: [
      ...
      { to: "/login", label: "Стать поваром на Селине" },
  ...
  },
  {
    ...
    en: {
      ...
      body: [
        ...
        { h: "How to place the order and pay", p: ["Combine a menu from different cooks in one cart: salads from one, the main from another, the cake from a third — that's fine. Choose delivery by the cook for a specific hour or pickup. During the free launch, payment is cash on delivery, directly to the cook, with no cards or prepayment.", "Place your birthday order in advance, especially on weekends: cooks prepare popular dishes and cakes for a specific date, so it's best to claim a slot in their schedule early."] },
  ...
  },
  {
    ...
    en: {
      ...
      body: [
        ...
        { h: "Delivery, pickup, and payment", p: ["Pick what suits you: delivery of a warm pie by the cook or pickup near your home. During the free launch, payment is cash on delivery, directly to the cook, with no cards or prepayment.", "Tip: order pies in advance, especially for a holiday or a big gathering — they're baked to order, not kept ready-made."] },
  ...
  },
  {
    ...
    en: {
      ...
      body: [
        ...
        { h: "Delivery, pickup, and payment", p: ["Choose delivery by the cook or pickup near your home. Cakes and delicate desserts are best picked up yourself or ask the cook about packaging. During the free launch, payment is cash on delivery, directly to the cook, with no cards or prepayment.", "Place cake and large orders in advance — they're baked just for you, not kept ready-made. A couple of days gives the cook time to plan everything."] },
        { h: "Do you bake? Become a cook", p: ["If baking is your thing, your home kitchen can bring in income. Starting is simple: register, set up a storefront with photos and ingredients, and set your price. Neighbors find you by search and distance, and your first honest reviews build your reputation.", "During the free launch the platform takes no commission — you receive payment directly from the buyer, cash on delivery."] },
  ...
  },
  {
    ...
    en: {
      ...
      body: [
        ...
        { h: "How to order homemade food for a memorial meal", p: ["On Celina you order dishes directly from verified neighbor-cooks. Open the feed, find cooks in your city, and see who makes soups, mains, and baking. Each has a storefront with photos, ingredients, and honest neighbor reviews.", "Gather the dishes you need in the cart — you can order from several cooks at once, say the soup from one and the pies from another. Choose delivery by the cook or pickup for the hour you need. During the free launch, payment is cash on delivery, directly to the cook, with no cards or prepayment."] },
  ...
  },
  {
    ...
    ru: {
      ...
      body: [
        ...
        { h: "Сколько это стоит?", p: ["Условия задаёт хозяин: у многих участие стоит как домашний ужин, а чаепития нередко бесплатные. Во время бесплатного пилота сервис не берёт комиссий, оплата — наличными напрямую хозяину."] },
    ...
    en: {
      ...
      body: [
        ...
        { h: "How much does it cost?", p: ["The host sets the terms: at many tables you pay about the cost of a home dinner, and tea parties are often free. During the free pilot the service charges no commission; payment is in cash directly to the host."] },
  ...
  },
  {
    ...
    ru: {
      ...
      body: [
        ...
        { h: "Как оплатить заказ?", p: ["Наличными при получении, напрямую повару. Онлайн-оплата на этапе пилота не используется."] },
    ...
    en: {
      ...
      body: [
        ...
        { h: "Cash on delivery", p: ["During the free launch there is one payment method, and it's the calmest one — cash on delivery, directly to the cook. No prepayments, no linked cards: you pay when the order is already in your hands. For the buyer it's simple protection — food first, money after."] },
        ...
        { h: "How much does delivery cost?", p: ["Delivery terms are set by the cook and shown before you place the order. There are no platform fees during the free launch."] },
        { h: "How do I pay for the order?", p: ["Cash on delivery, directly to the cook. Online payment is not used during the pilot."] },
  ...
  },
  {
    ...
    ru: {
      ...
      body: [
        ...
        { h: "Как это работает в Петербурге", p: ["На Селине домашнюю еду готовят проверенные соседи-повара. Откройте страницу города, посмотрите, кто готовит рядом — на Васильевском, в Купчино, на Петроградке или в Мурино, — выберите блюда и оформите заказ с доставкой или самовывозом. Повар живёт в паре кварталов, поэтому суп доезжает горячим даже в ноябрьскую слякоть.", "Каждый повар проходит проверку личности по документам, у блюд открыт состав, а оплата — наличными при получении: сначала видите заказ, потом платите. Во время пилота сервис не берёт комиссий."] },
        ...
        { h: "С чего начать", p: ["Загляните на страницу «Домашняя еда в Санкт-Петербурге», посмотрите поваров рядом и закажите первый обед. Если в вашем районе поваров пока нет — сервис только запускается: оставьте заявку или расскажите о Селине соседке, которая печёт лучшие в парадной пироги. С неё в вашем районе всё и начнётся.", "Не хочется ужинать в одиночку — посмотрите встречи за общим столом: соседские ужины проходят и в Петербурге."] },
      ],
    },
    en: {
  ...
  },
  {
    ...
    ru: {
      ...
      body: [
        ...
        { h: "Когда готовить некогда: обед от соседа", p: ["В будни обед чаще всего проигрывает работе: некогда варить, некогда даже думать. Для таких дней есть соседи-повара на Селине: настоящий домашний суп и второе, приготовленные сегодня в паре кварталов от вас, — с доставкой домой, к офису или самовывозом за пять минут.", "Многие повара собирают полноценные комплексные обеды и готовы готовить регулярно — договоритесь напрямую, и вопрос «что на обед» исчезнет из вашей жизни. Оплата наличными при получении, во время пилота без комиссий."] },
      ],
    },
    en: {
  ...
  },
  {
    ...
    ru: {
      ...
      body: [
        ...
        { h: "С чего начать", p: ["Откройте страницу «Домашняя еда в Новосибирске», посмотрите, кто готовит рядом, и закажите первый обед. Поваров в вашем районе пока нет? Сервис только запускается — оставьте заявку или расскажите о Селине соседке, которая лепит лучшие пельмени в подъезде: с неё всё и начнётся."] },
      ],
    },
    en: {
      ...
      body: [
        ...
        { h: "Where to start", p: ["Open the 'Homemade food in Novosibirsk' page, see who cooks nearby and order your first meal. No cooks in your district yet? The service is just launching — leave a request or tell the neighbor who makes the best pelmeni in your building about Celina."] },
      ],
    },
  },
  {
    ...
    ru: {
      ...
      body: [
        ...
        { h: "С чего начать", p: ["Загляните на страницу «Домашняя еда в Екатеринбурге», выберите повара рядом и закажите первый обед. Если поваров в районе пока мало — сервис запускается: оставьте заявку, а если сами печёте лучшие в доме шаньги — присоединяйтесь как повар, во время пилота это бесплатно."] },
      ],
    },
    en: {
      ...
      body: [
        ...
        { h: "Where to start", p: ["Visit the 'Homemade food in Yekaterinburg' page, choose a cook nearby and order your first meal. Few cooks in your district yet? The service is just launching — leave a request, or join as a cook if your shangi are the best in the building; it's free during the pilot."] },
      ],
    },
  },
  {
    ...
    en: {
      ...
      body: [
        ...
        { h: "How it works", p: ["Verified neighbors cook on Celina: open the city page, choose a cook nearby and order with delivery or pickup. Cooked in your district — echpochmaks arrive warm, like from grandma's oven.", "Every cook passes identity verification; cash on receipt; no commissions during the pilot."] },
  ...
  },
  {
    ...
    ru: {
      ...
      body: [
        ...
        { h: "С чего начать", p: ["Загляните на страницу «Домашняя еда в Нижнем Новгороде», посмотрите поваров рядом и закажите первый обед. Если поваров в вашем районе пока нет — сервис только запускается: оставьте заявку или расскажите о Селине соседке, чьи пироги знает вся лестничная площадка. С неё в вашем дворе всё и начнётся.", "А если не хочется ужинать в одиночку — загляните во встречи за общим столом: соседские ужины проходят и в Нижнем."] },
      ],
    },
    en: {
  ...
  },
  {
    ...
    ru: {
      ...
      body: [
        ...
        { h: "Как это работает", p: ["На Селине готовят проверенные соседи-повара. Откройте страницу города, посмотрите, кто готовит рядом — в Фестивальном (ФМР), Юбилейном (ЮМР), Комсомольском микрорайоне, на Гидростроителей или в Пашковском, — выберите блюда и оформите заказ с доставкой или самовывозом. Повар живёт в паре кварталов, поэтому обед не едет через весь город в пробках по Красной: между плитой и вашим столом — минуты.", "Каждый повар проходит проверку личности по документам, у блюд открыт состав, а оплата — наличными при получении: сначала видите заказ, потом платите. Во время пилота сервис не берёт комиссий."] },
        ...
        { h: "С чего начать", p: ["Загляните на страницу «Домашняя еда в Краснодаре», посмотрите поваров рядом и закажите первый обед. Если поваров в вашем районе пока нет — сервис только запускается: оставьте заявку или расскажите о Селине соседке, чьи вареники и аджику знает весь подъезд. С неё в вашем дворе всё и начнётся.", "А если не хочется ужинать в одиночку — загляните во встречи за общим столом: соседские ужины проходят и в Краснодаре."] },
      ],
    },
    en: {
  ...
  },
  {
    ...
    ru: {
      ...
      body: [
        ...
        { h: "Как это работает", p: ["На Селине готовят проверенные соседи-повара. Откройте страницу города, посмотрите, кто готовит рядом — в Западном, на Северном, в центре у Старого базара, в Нахичевани, на Сельмаше или в Левенцовке, — выберите блюда и оформите заказ с доставкой или самовывозом. Повар живёт в паре кварталов, поэтому обед не едет через весь город в пробках по Большой Садовой: между плитой и вашим столом — минуты.", "Каждый повар проходит проверку личности по документам, у блюд открыт состав, а оплата — наличными при получении: сначала видите заказ, потом платите. Во время пилота сервис не берёт комиссий."] },
        ...
        { h: "С чего начать", p: ["Загляните на страницу «Домашняя еда в Ростове-на-Дону», посмотрите поваров рядом и закажите первый обед. Если поваров в вашем районе пока нет — сервис только запускается: оставьте заявку или расскажите о Селине соседке, чью уху и вареники знает весь двор. С неё в вашем подъезде всё и начнётся.", "А если не хочется ужинать в одиночку — загляните во встречи за общим столом: соседские ужины проходят и в Ростове."] },
      ],
    },
    en: {
  ...
  },
  {
    ...
    ru: {
      ...
      body: [
        ...
        { h: "Как это работает", p: ["На Селине готовят проверенные соседи-повара. Откройте страницу города, посмотрите, кто готовит рядом — в Черниковке, Сипайлово, Инорсе, Зелёной роще, Дёме или Затоне, — выберите блюда и оформите заказ с доставкой или самовывозом. Повар живёт в паре кварталов, поэтому обед не тянется через весь город в пробках по проспекту Октября: между плитой и вашим столом — минуты.", "Каждый повар проходит проверку личности по документам, у блюд открыт состав, а оплата — наличными при получении: сначала видите заказ, потом платите. Во время пилота сервис не берёт комиссий — вся сумма достаётся повару."] },
        ...
        { h: "С чего начать", p: ["Загляните на страницу «Домашняя еда в Уфе», посмотрите поваров рядом и закажите первый обед. Если поваров в вашем районе пока нет — сервис только запускается: оставьте заявку или расскажите о Селине соседке, чьи эчпочмаки и чак-чак знает весь двор. С неё в вашем подъезде всё и начнётся.", "И если впереди сентябрь и школьные будни — договоритесь с поваром о домашних обедах на учебную неделю: у ребёнка будет горячий суп и котлета вместо булки из буфета, а у вас — на одну заботу меньше."] },
      ],
    },
    en: {
  ...
  },
  {
    ...
    ru: {
      ...
      body: [
        ...
        { h: "Как заказать борщ у соседки", p: ["Откройте Селину, выберите город и найдите повара рядом, у которого борщ в меню — с фото, составом и отзывами соседей. Закажите с доставкой до двери или заберите сами — часто повар живёт в паре минут, и борщ доедет горячим, со сметаной и, если повезёт, с пампушками.", "Оплата наличными при получении: сначала видите и нюхаете — потом платите. Во время пилота сервис не берёт комиссий, так что цена честная: обычно как бизнес-ланч, только это настоящий борщ на два дня."] },
    ...
    en: {
      ...
      body: [
        ...
        { h: "How to order from a neighbor", p: ["Open Celina, find a cook nearby with borscht on the menu — photo, ingredients, neighbors' reviews. Delivery to your door or pickup minutes away, hot, with smetana. Cash on receipt: see it, smell it, then pay. No commissions during the pilot — usually the price of a café lunch, but it's real borscht for two days."] },
      ],
    },
  },
  {
    ...
    ru: {
      ...
      body: [
        ...
        { h: "Во сколько обойдётся домашний ужин на двоих?", p: ["Обычно — в треть ресторанного счёта: вы платите за еду, а не за аренду зала и наценку. Оплата наличными при получении, во время пилота без комиссий. А если хочется ужина в компании — загляните на соседские застолья: иногда лучшее свидание — это стол, где смеются шестеро."] },
      ],
    },
    en: {
  ...
  },
  {
    ...
    en: {
      ...
      body: [
        ...
        { h: "Why it beats the café", p: ["Café syrniki were fried who-knows-when and microwaved. Your neighbor's came off the pan ten minutes before you. Usually cheaper than a café set too — no commissions during the pilot. And the best part: Sunday breakfast without cooking, while the family still sleeps."] },
      ],
    },
  },
  {
    ...
    en: {
      ...
      body: [
        ...
        { h: "The real cost of ordering", p: ["Restaurant delivery is pricey daily; subscription plans are conveyor food. A neighbor cook's lunch usually costs like a business lunch: no rent, staff or marketing in the price. No commissions during the pilot; a big-pot order stretches over days and beats even your own cooking on honest math."] },
  ...
  },
  {
    ...
    en: {
      ...
      body: [
        ...
        { h: "Setting up 'your neighbor with a pot'", p: ["Order a trial lunch from a cook nearby; if it clicks, arrange regular days in the chat. No commissions during the pilot — cheaper than meal plans, and the taste is literally homemade."] },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    ru: {
      ...
      body: [
        ...
        { h: "Как заказать еду на компанию на Селине", p: ["Откройте ленту, выберите поваров рядом и соберите стол: на Селине можно заказать сразу у нескольких поваров — у одного плов, у другого выпечку и салаты. Укажите дату и час, к которому нужно всё приготовить, и выберите доставку до двери или самовывоз.", "Оплата наличными при получении, без предоплат и комиссий в пилотный период. Оформляйте заранее — за день-два до застолья, чтобы повара успели приготовить всё свежим именно к вашему вечеру. А если собираете соседей, загляните в «Застолья»: иногда компания уже собирается рядом с вами."] },
      ],
    },
    en: {
  ...
  },
  {
    ...
    ru: {
      ...
      body: [
        ...
        { h: "С чего начать", p: ["Загляните на страницу «Домашняя еда в Красноярске», посмотрите поваров рядом и закажите первый обед. Если в вашем районе поваров пока нет — сервис только запускается: оставьте заявку или расскажите о Селине соседке, чьи пельмени и шаньги знает весь подъезд. С неё в вашем доме всё и начнётся.", "И если готовите вы сами и делаете это хорошо — заведите профиль повара. На Взлётке, в Северном и Солнечном людей много, кухонь мало, а желающих съесть нормальный домашний суп в среду вечером — весь дом."] },
      ],
      faq: [
        ...
        { q: "Сколько стоит домашняя еда в Красноярске?", a: "Цену назначает сам повар. Обычно порция домашней еды выходит дешевле ресторанной и больше по объёму — вы платите за еду, а не за зал и обслуживание. На этапе бесплатного пилота Селина не берёт комиссию, поэтому наценки сервиса в цене нет вообще." },
        ...
        { q: "Как стать домашним поваром в Красноярске?", a: "Заведите профиль повара, пройдите проверку личности и поставьте в меню то, что вы готовите и так: пельмени, супы, шаньги, пироги, заготовки. Во время пилота сервис не берёт комиссию — повар получает всю сумму заказа целиком." },
      ],
    },
    en: {
      ...
      faq: [
        ...
        { q: "What does home-cooked food cost in Krasnoyarsk?", a: "The cook sets the price. A home-cooked portion is usually cheaper than a restaurant one and larger — you pay for the food, not for a dining room and service. During the free pilot Celina charges no commission, so there is no service markup in the price at all." },
        ...
        { q: "How do I become a home cook in Krasnoyarsk?", a: "Set up a cook profile, pass identity verification and list what you already cook: pelmeni, soups, shangi, pies, preserves. During the pilot the service takes no commission — the cook keeps the whole order amount." },
      ],
    },
  },
];
