...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    links: [
      { to: "/blog/domashnyaya-eda-v-permi", label: "Домашняя еда в Перми: посикунчики и пельмени" },
  ...
  },
  {
    ...
    links: [
      ...
      { to: "/login?mode=register&role=cook", label: "Стать поваром на Celina" },
      { to: "/blog/domashnyaya-eda-v-samare", label: "Домашняя еда в Самаре" },
    ],
    ru: {
  ...
  },
  {
    ...
    links: [
      { to: "/blog/domashnyaya-eda-v-permi", label: "Домашняя еда в Перми" },
  ...
  },
  {
    ...
    links: [
      { to: "/blog/domashnyaya-eda-v-permi", label: "Домашняя еда в Перми: грузди и рыжики" },
  ...
  {
    slug: "domashnyaya-eda-v-samare",
    cover: "/images/dishes/ukha.jpg",
    date: "2026-08-23",
    readMin: 6,
    tags: ["самара", "поволжье", "домашняя еда", "доставка", "город"],
    links: [
      { to: "/eda/samara", label: "Домашняя еда в Самаре — страница города" },
      { to: "/blog/domashnyaya-eda-v-kazani", label: "Домашняя еда в Казани" },
      { to: "/blog/domashnyaya-eda-v-nizhnem-novgorode", label: "Домашняя еда в Нижнем Новгороде" },
      { to: "/blog/tatarskaya-kuhnya-echpochmaki-chak-chak", label: "Татарская кухня: эчпочмаки, губадия, чак-чак" },
      { to: "/zagotovki", label: "Домашние заготовки: соленья и варенье" },
      { to: "/blog/eda-na-dachu-i-piknik", label: "Еда на дачу и пикник" },
      { to: "/detskoe-menyu", label: "Детское меню на заказ" },
      { to: "/eda-na-nedelyu", label: "Готовая еда на неделю" },
    ...
    ru: {
      title: "Домашняя еда в Самаре: рыба с Волги, пироги и обеды",
      excerpt:
        "Гид по домашней еде в Самаре: волжская рыба и уха, татарская выпечка, обеды на смену и дачные заготовки с просек — от Безымянки до Красной Глинки.",
      body: [
        { p: ["Самара вытянута вдоль Волги на десятки километров, и это не фигура речи: от Красной Глинки до Самарского района ехать через лес и через весь центр. Поэтому слова «еда рядом» здесь значат разное в зависимости от того, где вы живёте. Рассказываем, как в Самаре заказать домашнюю еду — не «домашнюю» из цеха, а приготовленную соседом в вашем же квартале, — и что в этом городе вообще принято готовить дома."] },
        { h: "Как это работает", p: ["На Селине готовят соседи-повара: человек с именем, кухней в вашем районе и открытым составом блюд. Вы открываете страницу города, смотрите, кто готовит рядом — на Безымянке, в Крутых Ключах, на Управленческом, в старом центре у Ленинградской, — выбираете блюда и оформляете заказ с доставкой от повара или самовывозом. Повар живёт в паре кварталов, поэтому обед не едет к вам через Московское шоссе в час пик.", "Каждый повар проходит проверку личности по документам, у блюд открыт состав, а оплата — наличными при получении: сначала вы видите еду, потом платите. Комиссию сервис сейчас не берёт — вся сумма достаётся повару.", "Говорим прямо: в Самаре поваров пока ноль, идёт набор первых, и витрину из несуществующих кухонь мы не рисуем. Если вы ищете, где заказать, — оставьте заявку на странице города: так мы видим, в каком районе ждут, и туда идём в первую очередь."] },
        { h: "Что в Самаре готовят дома", p: ["Волга даёт городу рыбу, и домашний стол это чувствует: уха, жареный судак, рыба, запечённая целиком, и пирог с рыбой — не праздничный, а нормальный воскресный, как в любом городе на большой воде.", "Вторая линия — татарская. На Кировском рынке прилавки с эчпочмаками и губадией стоят рядом с мясными, и для многих самарских семей это не «национальная кухня», а то, что печёт бабушка. Что это за блюда и чем они отличаются друг от друга, мы разобрали в отдельной статье.", "Дальше — обычная домашняя классика, которую в Самаре готовят так же, как везде: борщ и щи на всю кастрюлю, котлеты с пюре, голубцы, пироги с капустой и с яблоком, блины и оладьи к чаю. И сильная среднеазиатская линия — плов, манты, лагман, самса: для части города это домашняя еда, а не ресторанная."] },
        { h: "Обед на смену: Безымянка и заводское расписание", p: ["Безымянка выросла вокруг эвакуированных заводов, и её расписание никуда не делось: смена, проходная, обед, который берут с собой из дома. Готовить на неделю вперёд, когда встаёшь в пять, получается не у всех — поэтому здесь чаще просят не разовый ужин, а несколько контейнеров сразу: суп, второе, гарнир, разогреть за четыре дня.", "Договориться о таком заказе с соседом-поваром проще, чем с любой доставкой: контейнеры забирают у подъезда или у остановки по дороге на смену, а не ждут курьера в окно доставки. Как устроены недельные заказы и сколько это выходит — на странице «Готовая еда на неделю»."] },
        { h: "Конец августа: просеки, банки и заволжская картошка", p: ["Вторая половина августа в Самаре — это дачи. С просек везут яблоки, сливу, помидоры и кабачки, а из-за Волги — из Рождествено и с Гавриловой Поляны — картошку, огурцы и зелень. К концу месяца на балконах выстраиваются банки, которые простоят до весны.", "Если урожай девать некуда, поставьте в меню то, что вы и так делаете: аджику, лечо, компоты, варенье, солёные огурцы. Если дачи нет — банку проще взять у соседки, чем в магазине: домашние заготовки расходятся быстрее, чем появляются. Что и как заготавливать — на странице заготовок.", "И ещё одна августовская тема — Успенский пост, с 14 по 27 августа. Постное меню домашняя кухня собирает без труда: грибной суп, пирожки с капустой, вареники с картошкой, гречка с грибами. Достаточно написать повару в чате: без яиц, молока и сметаны."] },
        { h: "Еда, которую берут с собой", p: ["Самарский выходной — это чаще всего выезд: набережная, дача на просеке, паром за Волгу, Жигулёвские горы со стороны Ширяево. И каждый раз встаёт один и тот же вопрос: что взять поесть. Пирожки, котлеты, варёные яйца, огурцы, термос — набор, который переживает рюкзак и не просит холодильника. Договориться о таком заказе с поваром накануне проще, чем вставать в шесть утра к плите; что ещё берут на дачу и пикник — в отдельном гиде."] },
        { h: "Скоро школа", p: ["До 1 сентября осталась неделя с небольшим, и вместе с ним возвращается родительский вопрос: чем кормить ребёнка в учебные дни, если вы на работе до семи. Обеды на учебную неделю у соседа-повара — рабочий вариант: горячий суп и котлета вместо булки по дороге. То, что для ребёнка важно, обсуждается заранее и в переписке: без лука, не остро, порция поменьше, аллергены. Как это устроено — на странице детского меню."] },
        { h: "С чего начать", p: ["Загляните на страницу «Домашняя еда в Самаре» и посмотрите, что есть рядом с вами. Пока там пусто — оставьте заявку: список районов, где домашнюю еду ждут, и есть наша карта набора.", "А если готовите вы сами и делаете это хорошо — заведите профиль повара. На Безымянке, в Крутых Ключах и Южном городе людей много, кухонь мало, а желающих съесть нормальный домашний суп в среду вечером — весь дом. Город длинный: первый повар в районе забирает соседей себе, потому что до вас им ближе, чем до кого-либо другого."] },
      ],
      faq: [
        { q: "Как заказать домашнюю еду в Самаре?", a: "Откройте страницу «Домашняя еда в Самаре» на Селине и посмотрите, кто готовит рядом — на Безымянке, в старом центре, в Крутых Ключах, на Управленческом или Красной Глинке. Дальше как обычно: блюда в корзину, доставка от повара или самовывоз, оплата наличными при получении. Сейчас в городе идёт набор первых поваров, поэтому если рядом пока никого нет — оставьте заявку на той же странице." },
        { q: "Поваров в Самаре ещё нет — зачем тогда страница города?", a: "Это набор первых. Заказать прямо сейчас не у кого, и мы честно об этом пишем, а не показываем несуществующую витрину. Заявки с адресами районов показывают, где домашнюю еду ждут: как только на вашей улице появится кухня, она будет видна на странице города." },
        { q: "Безымянка, центр и Красная Глинка — фактически разные города. Через весь город еду повезут?", a: "Нет, и в этом смысл. Повар готовит для своей округи и сам назначает место передачи: у подъезда, у остановки, у проходной. С Мехзавода в Самарский район никто ничего не везёт — вместо этого в каждом районе появляется свой повар." },
        { q: "Сколько стоит домашняя еда в Самаре?", a: "Цену назначает сам повар. Обычно домашняя порция выходит дешевле ресторанной и больше по объёму: вы платите за еду, а не за зал и обслуживание. Сейчас Селина не берёт комиссию, поэтому наценки сервиса в цене нет вообще." },
        { q: "Готовят ли в Самаре волжскую рыбу и татарскую выпечку?", a: "Меню каждый повар составляет сам, поэтому уха, жареный судак, рыбный пирог, эчпочмаки и губадия появляются там, где повар их делает, — отдельного раздела в меню под них нет. Проще спросить в чате или прочитать описание кухни: многое зависит от сезона и от того, что человек успел заготовить." },
        { q: "Как стать домашним поваром в Самаре?", a: "Заведите профиль повара, пройдите проверку личности и поставьте в меню то, что вы готовите и так: супы, пироги, выпечку, обеды на неделю, заготовки. Помещение и аренда не нужны — вы готовите на своей кухне. Комиссию сервис не берёт: повар получает всю сумму заказа целиком." },
      ],
    },
    en: {
      title: "Homemade Food in Samara: Volga Fish, Pies and Lunches",
      excerpt:
        "A guide to home-cooked food in Samara: Volga fish and ukha, Tatar baking, lunches for the factory shift and dacha preserves — from Bezymyanka to Krasnaya Glinka.",
      body: [
        { p: ["Samara stretches for tens of kilometres along the Volga, and that is not a figure of speech: getting from Krasnaya Glinka to the Samarsky district means driving through a forest and then through the whole city centre. So the words 'food nearby' mean very different things depending on where you live. Here's how to order real homemade food in Samara — cooked by a neighbor in your own block, not 'homestyle' out of a plant — and what people in this city actually cook at home."] },
        { h: "How it works", p: ["On Celina the cooking is done by neighbor cooks: a person with a name, a kitchen in your district and dishes that list their ingredients. Open the city page, see who cooks nearby — in Bezymyanka, Krutye Klyuchi, Upravlenchesky, or the old centre around Leningradskaya — pick dishes and order with delivery from the cook or pickup. The cook lives a couple of blocks away, so your lunch doesn't travel down Moskovskoye shosse in rush hour.", "Every cook passes identity verification, dishes list their ingredients, and payment is cash on receipt: first you see the food, then you pay. The service charges no commission right now — the cook keeps the full amount.", "Plainly: Samara has no cooks yet, the first ones are being recruited, and we don't draw a shop window out of kitchens that don't exist. If you're looking to order, leave a request on the city page — that's how we see which district is waiting, and that's where we go first."] },
        { h: "What people cook at home in Samara", p: ["The Volga gives the city fish, and the home table shows it: ukha, fried pike-perch, whole baked fish, and fish pie — not a holiday dish but an ordinary Sunday one, as in any city on big water.", "The second line is Tatar. At the Kirovsky market, stalls with echpochmaki and gubadiya stand next to the butchers, and for many Samara families that isn't 'national cuisine' but what grandma bakes. We covered those dishes in a separate article.", "Then comes the ordinary home classics cooked here the same as everywhere: big-pot borscht and shchi, cutlets with mash, golubtsy, cabbage and apple pies, blini and oladyi for tea. And a strong Central Asian line — plov, manty, lagman, samsa: for part of the city that's family food, not restaurant food."] },
        { h: "Lunch for the shift: Bezymyanka and the factory clock", p: ["Bezymyanka grew up around factories evacuated here during the war, and its schedule hasn't gone anywhere: the shift, the gate, the lunch you bring from home. Cooking a week ahead when you get up at five doesn't work for everyone — so here people more often ask not for a single dinner but for several containers at once: soup, a main, a side, reheated over four days.", "Arranging that with a neighbor cook is easier than with any delivery service: you collect the containers at your entrance or at the bus stop on your way to the shift, instead of waiting for a courier inside a delivery window."] },
        { h: "Late August: dacha rows, jars and potatoes from across the river", p: ["The second half of August in Samara is about the dachas. Apples, plums, tomatoes and courgettes come in from the proseki, and potatoes, cucumbers and greens come across the Volga from Rozhdestveno and Gavrilova Polyana. By the end of the month the jars line up on the balconies and stay there until spring.", "If the harvest has nowhere left to go, list what you already make: adjika, lecho, compote, jam, salted cucumbers. If you have no dacha, a jar is easier to get from a neighbor than from a shop — homemade preserves sell faster than they appear.", "One more August subject is the Dormition Fast, 14–27 August. A home kitchen handles a lean menu easily: mushroom soup, cabbage pirozhki, potato vareniki, buckwheat with mushrooms. Just tell the cook in chat: no eggs, milk or sour cream."] },
        { h: "Food you take with you", p: ["A Samara weekend usually means going somewhere: the embankment, a dacha on the proseki, the ferry across the Volga, the Zhiguli hills over at Shiryaevo. And the same question comes up every time — what to take to eat. Pirozhki, cutlets, boiled eggs, cucumbers and a thermos: a set that survives a backpack and asks for no fridge. Arranging it with a cook the evening before beats getting up at six to fry it yourself."] },
        { h: "School is coming", p: ["There's a little over a week until 1 September, and with it the old parental question returns: what does the child eat on school days if you're at work until seven. Weekday lunches from a neighbor cook work well — hot soup and a cutlet instead of a bun grabbed on the way. Whatever matters for your child is settled in advance and in writing: no onion, nothing spicy, a smaller portion, allergens."] },
        { h: "Where to start", p: ["Open the 'Homemade food in Samara' page and see what's nearby. While it's still empty, leave a request: the list of districts that are waiting is our recruitment map.", "And if you're the one who cooks well — set up a cook profile. In Bezymyanka, Krutye Klyuchi and Yuzhny Gorod there are plenty of people, few kitchens, and a whole building that would like a proper home-cooked soup on a Wednesday evening. The city is long: the first cook in a district takes the neighborhood, because you're closer to them than anyone else is."] },
      ],
      faq: [
        { q: "How do I order homemade food in Samara?", a: "Open the 'Homemade food in Samara' page on Celina and see who cooks near you — in Bezymyanka, the old centre, Krutye Klyuchi, Upravlenchesky or Krasnaya Glinka. Then it's the usual: dishes into the cart, delivery from the cook or pickup, cash on receipt. The city is currently recruiting its first cooks, so if nobody is nearby yet, leave a request on the same page." },
        { q: "There are no cooks in Samara yet — what is the city page for?", a: "It's a recruitment page. There is nobody to order from right now, and we say so instead of showing a shop window that doesn't exist. Requests with district names show where home food is wanted: as soon as a kitchen opens on your street, it will appear on the city page." },
        { q: "Bezymyanka, the centre and Krasnaya Glinka are effectively different cities. Will food be driven across town?", a: "No, and that's the point. A cook cooks for their own neighborhood and picks the handover spot themselves: at the entrance, at the bus stop, at the factory gate. Nothing travels from Mekhzavod to the Samarsky district — instead, each district gets its own cook." },
        { q: "What does home-cooked food cost in Samara?", a: "The cook sets the price. A home portion is usually cheaper than a restaurant one and larger: you pay for the food, not for a dining room and service. Celina charges no commission right now, so there is no service markup in the price at all." },
        { q: "Do cooks in Samara make Volga fish and Tatar baking?", a: "Each cook builds their own menu, so ukha, fried pike-perch, fish pie, echpochmaki and gubadiya show up wherever a cook makes them — there is no separate menu section for them. Ask in chat or read the kitchen description: much depends on the season and on what the person managed to put up." },
        { q: "How do I become a home cook in Samara?", a: "Set up a cook profile, pass identity verification and list what you already cook: soups, pies, baking, weekly lunches, preserves. You need no premises and no rent — you cook in your own kitchen. The service takes no commission: the cook keeps the whole order amount." },
      ],
    },
  },
  {
    slug: "domashnyaya-eda-v-permi",
    cover: "/images/pelmeni.jpg",
    date: "2026-08-25",
    readMin: 6,
    tags: ["пермь", "прикамье", "домашняя еда", "доставка", "город"],
    links: [
      { to: "/eda/perm", label: "Домашняя еда в Перми — страница города" },
      { to: "/blog/domashnie-pelmeni-po-regionam-rossii", label: "Домашние пельмени по регионам России" },
      { to: "/blog/domashnyaya-eda-v-ekaterinburge", label: "Домашняя еда в Екатеринбурге" },
      { to: "/blog/domashnyaya-eda-v-chelyabinske", label: "Домашняя еда в Челябинске" },
      { to: "/blog/chto-prigotovit-iz-gribov", label: "Что приготовить из грибов" },
    ...
    ru: {
      title: "Домашняя еда в Перми: посикунчики, пельмени и обеды",
      excerpt:
        "Гид по домашней еде в Перми: посикунчики и пельмени, шаньги, обед на смену и осенние грузди — от Закамска и Гайвы до Паркового и Мотовилихи.",
      body: [
        { p: ["Пермь вытянута вдоль Камы почти на семьдесят километров, и это меняет весь разговор о еде. От Гайвы до Закамска — час дороги, если повезёт с мостами, поэтому «привезите горячее» с одного конца города на другой здесь звучит наивно: доедет уже не горячее. Рассказываем, как в Перми заказать домашнюю еду — не «домашнюю» из производственного цеха, а приготовленную соседом из вашего же района, — и что в этом городе вообще принято готовить дома."] },
        { h: "Как это работает", p: ["На Селине готовят соседи-повара: человек с именем, кухней в вашем районе и открытым составом блюд. Вы открываете страницу города, смотрите, кто готовит рядом — в Закамске, на Гайве, в Мотовилихе, на Парковом, в Балатово или в центре, — выбираете блюда и оформляете заказ с доставкой от повара или самовывозом. Повар живёт в паре кварталов, поэтому обед не едет к вам через Коммунальный мост в час пик.", "Каждый повар проходит проверку личности по документам, у блюд открыт состав, а оплата — наличными при получении: сначала вы видите еду, потом платите. Комиссию сервис сейчас не берёт — вся сумма достаётся повару.", "Говорим прямо: в Перми поваров пока ноль, идёт набор первых, и витрину из несуществующих кухонь мы не рисуем. Если вы ищете, где заказать, — оставьте заявку на странице города: так мы видим, в каком районе домашнюю еду ждут, и туда идём в первую очередь."] },
        { h: "Что в Перми готовят дома", p: ["Начинается пермский стол с посикунчиков — маленьких жареных пирожков с мясом, которые за пределами Прикамья почти никто не делает. Их либо жарит ваша бабушка, либо не жарит никто: в кафе они бывают, а вот купить чужие домашние в Перми негде.", "Второе — пельмени. Пермь считает их своим изобретением и выводит само слово из коми-пермяцкого «пельнянь», «хлебное ухо». Лепят их дома до сих пор, большой семьёй и на морозилку вперёд; чем пермские отличаются от уральских, сибирских и удмуртских, мы разбирали в отдельной статье.", "Дальше — шаньги с картошкой и с творогом, пироги с пистиками весной, грузди и рыжики осенью, уха и рыбные пироги, и обычная домашняя классика, которую в Перми готовят так же, как везде: борщ на всю кастрюлю, котлеты с пюре, голубцы, блины и оладьи к чаю."] },
        { h: "Обед на смену: Мотовилиха, Закамск и сменный график", p: ["Пермь — город заводской, и её расписание никуда не делось: моторный завод, Мотовилихинские заводы, нефтепереработка в Осенцах, сутки через трое, ночные смены. После ночной человек хочет горячего, а не разогретого в третий раз, но готовить в этот момент не может никто.", "Поэтому здесь чаще просят не разовый ужин, а несколько контейнеров сразу: суп, второе, гарнир — разогреть за четыре дня. Договориться о таком заказе с соседом-поваром проще, чем с любой доставкой: контейнеры забирают у подъезда или у остановки по дороге на смену, а не ждут курьера в окно доставки. Как устроены недельные заказы — на странице «Готовая еда на неделю»."] },
        { h: "Закамск и Гайва: районы, куда доставка едет неохотно", p: ["Чем дальше от центра, тем короче список в приложениях и тем дольше ждать. Закамск за Камой и Гайва на севере живут своей жизнью — со своими магазинами, школами и ощущением отдельного городка, — и обеды в бизнес-центры на Ленина к ним отношения не имеют.", "Для соседского сервиса это не проблема, а точка входа: повар готовит на свою округу и сам назначает место передачи — у подъезда, у остановки, у проходной. Первый повар в Закамске или на Парковом становится там единственным."] },
        { h: "Конец августа: грузди, рыжики и банки", p: ["Вторая половина августа в Прикамье — это лес и дача. Из-под Полазны, Краснокамска и Добрянки везут грузди и рыжики, с участков — кабачки, огурцы, сливу и яблоки, и к сентябрю на балконах выстраиваются банки, которые простоят до весны.", "Если урожай девать некуда, поставьте в меню то, что вы и так делаете: солёные грузди, аджику, лечо, компоты, варенье. Если ни дачи, ни леса нет — банку проще взять у соседки, чем в магазине: домашние заготовки расходятся быстрее, чем появляются. Что делать с грибами прямо сейчас — в отдельном гиде, а что и как закатывать — на странице заготовок."] },
        { h: "Скоро школа", p: ["До 1 сентября осталась неделя, и вместе с ним возвращается родительский вопрос: чем кормить ребёнка в учебные дни, если вы на работе до семи, а до дома через мост. Обеды на учебную неделю у соседа-повара — рабочий вариант: горячий суп и котлета вместо булки по дороге. То, что для ребёнка важно, обсуждается заранее и в переписке: без лука, не остро, порция поменьше, аллергены. Как это устроено — на странице детского меню."] },
        { h: "Студенты на Букирева и Комсомольском", p: ["Университеты тянут в Пермь молодёжь со всего Прикамья, и в съёмных квартирах на Комсомольском проспекте и вокруг Букирева еда — это доширак и то, что привезли из дома на выходных. Порция домашнего супа из соседнего подъезда стоит дешевле, чем доставка из кафе, и это, пожалуй, самый честный аргумент за весь сервис."] },
        { h: "С чего начать", p: ["Загляните на страницу «Домашняя еда в Перми» и посмотрите, что есть рядом с вами. Пока там пусто — оставьте заявку: список районов, где домашнюю еду ждут, и есть наша карта набора.", "А если готовите вы сами и делаете это хорошо — заведите профиль повара. Помещение и аренда не нужны, вы готовите на своей кухне. Город длинный: первый повар в районе забирает соседей себе, потому что до вас им ближе, чем до кого-либо другого."] },
      ],
      faq: [
        { q: "Как заказать домашнюю еду в Перми?", a: "Откройте страницу «Домашняя еда в Перми» на Селине и посмотрите, кто готовит рядом — в Закамске, на Гайве, в Мотовилихе, на Парковом, в Балатово или в центре. Дальше как обычно: блюда в корзину, доставка от повара или самовывоз, оплата наличными при получении. Сейчас в городе идёт набор первых поваров, поэтому если рядом пока никого нет — оставьте заявку на той же странице." },
        { q: "Поваров в Перми ещё нет — зачем тогда страница города?", a: "Это набор первых. Заказать прямо сейчас не у кого, и мы честно об этом пишем, а не показываем несуществующую витрину. Заявки с районами показывают, где домашнюю еду ждут: как только на вашей улице появится кухня, она будет видна на странице города." },
        { q: "Я в Закамске, туда всё едет плохо. Через весь город еду повезут?", a: "Нет, и в этом смысл. Повар готовит для своей округи и сам назначает место передачи: у подъезда, у остановки, у проходной. С Гайвы в Закамск никто ничего не везёт — вместо этого в каждом районе появляется свой повар. Чем хуже район закрыт доставкой, тем нужнее там своя кухня." },
        { q: "Сколько стоит домашняя еда в Перми?", a: "Цену назначает сам повар. Обычно домашняя порция выходит дешевле ресторанной и больше по объёму: вы платите за еду, а не за зал и обслуживание. Сейчас Селина не берёт комиссию, поэтому наценки сервиса в цене нет вообще." },
        { q: "Можно ли заказать посикунчики, пельмени или шаньги?", a: "Меню каждый повар составляет сам, поэтому посикунчики, пельмени, шаньги, пироги с пистиками и солёные грузди появляются там, где повар их делает, — отдельного раздела в меню под них нет. Проще спросить в чате или прочитать описание кухни: многое зависит от сезона и от того, что человек успел заготовить." },
        { q: "Как стать домашним поваром в Перми?", a: "Заведите профиль повара, пройдите проверку личности и поставьте в меню то, что вы готовите и так: посикунчики, пельмени, супы, обеды на неделю, заготовки. Помещение и аренда не нужны — вы готовите на своей кухне. Комиссию сервис не берёт: повар получает всю сумму заказа целиком." },
      ],
    },
    en: {
      title: "Homemade Food in Perm: Posikunchiki, Pelmeni and Lunches",
      excerpt:
        "A guide to home-cooked food in Perm: posikunchiki and pelmeni, shangi, lunches for the factory shift and autumn milk-caps — from Zakamsk and Gaiva to Parkovy.",
      body: [
        { p: ["Perm stretches almost seventy kilometres along the Kama, and that changes the whole conversation about food. Gaiva to Zakamsk is an hour on the road if the bridges are kind, so 'bring something hot over' from one end of the city to the other is naive here: it won't arrive hot. Here's how to order real homemade food in Perm — cooked by a neighbor in your own district, not 'homestyle' out of a plant — and what people in this city actually cook at home."] },
        { h: "How it works", p: ["On Celina the cooking is done by neighbor cooks: a person with a name, a kitchen in your district and dishes that list their ingredients. Open the city page, see who cooks nearby — in Zakamsk, Gaiva, Motovilikha, Parkovy, Balatovo or the centre — pick dishes and order with delivery from the cook or pickup. The cook lives a couple of blocks away, so your lunch doesn't cross the Kommunalny bridge in rush hour.", "Every cook passes identity verification, dishes list their ingredients, and payment is cash on receipt: first you see the food, then you pay. The service charges no commission right now — the cook keeps the full amount.", "Plainly: Perm has no cooks yet, the first ones are being recruited, and we don't draw a shop window out of kitchens that don't exist. If you're looking to order, leave a request on the city page — that's how we see which district is waiting, and that's where we go first."] },
        { h: "What people cook at home in Perm", p: ["The Perm table starts with posikunchiki — small fried meat pies that almost nobody makes outside the Kama region. Either your grandmother fries them or nobody does: cafés have them, but there is nowhere to buy somebody else's homemade ones.", "Second come pelmeni. Perm considers them its own invention and traces the word itself to the Komi-Permyak 'pelnyan', 'bread ear'. People still make them at home, as a family and by the freezer-load; how the Perm version differs from the Urals, Siberian and Udmurt ones we covered in a separate article.", "Then come shangi with potato and with curd, pies with fiddlehead greens in spring, milk-caps and saffron milk-caps in autumn, fish soup and fish pies, and the ordinary home classics cooked here the same as everywhere: big-pot borscht, cutlets with mash, golubtsy, blini and oladyi for tea."] },
        { h: "Lunch for the shift: Motovilikha, Zakamsk and the rota", p: ["Perm is a factory city and its schedule hasn't gone anywhere: the engine plant, the Motovilikha works, the refinery in Osentsy, twenty-four hours on and three days off, night shifts. After a night shift a person wants something hot rather than something reheated for the third time, and that is exactly the moment nobody can cook.", "So here people more often ask not for a single dinner but for several containers at once: soup, a main, a side, reheated over four days. Arranging that with a neighbor cook is easier than with any delivery service: you collect the containers at your entrance or at the bus stop on the way to the shift, instead of waiting for a courier inside a delivery window."] },
        { h: "Zakamsk and Gaiva: the districts delivery avoids", p: ["The further from the centre, the shorter the list in the apps and the longer the wait. Zakamsk across the Kama and Gaiva in the north live their own life — their own shops, their own schools, the feel of a separate town — and office lunches on Lenina street have nothing to do with them.", "For a neighborhood service that isn't a problem but an entry point: the cook cooks for their own area and picks the handover spot themselves — at the entrance, at the bus stop, at the factory gate. The first cook in Zakamsk or Parkovy becomes the only one there."] },
        { h: "Late August: milk-caps, saffron milk-caps and jars", p: ["The second half of August in the Kama region is about the forest and the dacha. Milk-caps and saffron milk-caps come in from around Polazna, Krasnokamsk and Dobryanka; courgettes, cucumbers, plums and apples come from the plots, and by September the jars line up on the balconies and stay there until spring.", "If the harvest has nowhere left to go, list what you already make: salted milk-caps, adjika, lecho, compote, jam. And if you have neither a dacha nor a forest, a jar is easier to get from a neighbor than from a shop — homemade preserves sell faster than they appear."] },
        { h: "School is coming", p: ["There's a week until 1 September, and with it the old parental question returns: what does the child eat on school days if you're at work until seven and home is across the bridge. Weekday lunches from a neighbor cook work well — hot soup and a cutlet instead of a bun grabbed on the way. Whatever matters for your child is settled in advance and in writing: no onion, nothing spicy, a smaller portion, allergens."] },
        { h: "Students on Bukireva and Komsomolsky", p: ["The universities pull young people into Perm from all over the region, and in the rented flats along Komsomolsky prospekt and around Bukireva street food means instant noodles and whatever was brought from home at the weekend. A portion of homemade soup from the next entrance costs less than delivery from a café, and that is probably the most honest argument for the whole service."] },
        { h: "Where to start", p: ["Open the 'Homemade food in Perm' page and see what's nearby. While it's still empty, leave a request: the list of districts that are waiting is our recruitment map.", "And if you're the one who cooks well — set up a cook profile. You need no premises and no rent, you cook in your own kitchen. The city is long: the first cook in a district takes the neighborhood, because you're closer to them than anyone else is."] },
      ],
      faq: [
        { q: "How do I order homemade food in Perm?", a: "Open the 'Homemade food in Perm' page on Celina and see who cooks near you — in Zakamsk, Gaiva, Motovilikha, Parkovy, Balatovo or the centre. Then it's the usual: dishes into the cart, delivery from the cook or pickup, cash on receipt. The city is currently recruiting its first cooks, so if nobody is nearby yet, leave a request on the same page." },
        { q: "There are no cooks in Perm yet — what is the city page for?", a: "It's a recruitment page. There is nobody to order from right now, and we say so instead of showing a shop window that doesn't exist. Requests with district names show where home food is wanted: as soon as a kitchen opens on your street, it will appear on the city page." },
        { q: "I'm in Zakamsk and nothing gets delivered here. Will food be driven across town?", a: "No, and that's the point. A cook cooks for their own neighborhood and picks the handover spot themselves: at the entrance, at the bus stop, at the factory gate. Nothing travels from Gaiva to Zakamsk — instead, each district gets its own cook. The worse a district is served by delivery, the more it needs its own kitchen." },
        { q: "What does home-cooked food cost in Perm?", a: "The cook sets the price. A home portion is usually cheaper than a restaurant one and larger: you pay for the food, not for a dining room and service. Celina charges no commission right now, so there is no service markup in the price at all." },
        { q: "Can I order posikunchiki, pelmeni or shangi?", a: "Each cook builds their own menu, so posikunchiki, pelmeni, shangi, fiddlehead pies and salted milk-caps show up wherever a cook makes them — there is no separate menu section for them. Ask in chat or read the kitchen description: much depends on the season and on what the person managed to put up." },
        { q: "How do I become a home cook in Perm?", a: "Set up a cook profile, pass identity verification and list what you already cook: posikunchiki, pelmeni, soups, weekly lunches, preserves. You need no premises and no rent — you cook in your own kitchen. The service takes no commission: the cook keeps the whole order amount." },
      ],
    },
  },
];
